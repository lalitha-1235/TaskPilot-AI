...
const initialTasks = [
  {
    id: "TP-101",
    name: "Design glassmorphism authentication screens",
    project: "TaskPilot Auth System",
    assignee: { name: "Sarah Jenkins", initials: "SJ", color: "bg-purple-600/30 text-purple-200 border-purple-500/40" },
    dueDate: "2026-07-10",
    priority: "High",
    status: "Review",
    progress: 85,
  ...
  {
    id: "TP-102",
    name: "Integrate dashboard layout & routes configuration",
    project: "TaskPilot Core Layout",
    assignee: { name: "Alex Riviera", initials: "AR", color: "bg-cyan-600/30 text-cyan-200 border-cyan-500/40" },
    dueDate: "2026-07-15",
    priority: "High",
    status: "In Progress",
    progress: 62,
  ...
  {
    id: "TP-103",
    name: "Write Cypress E2E test suite for authentication flow",
    project: "E2E Testing Pipeline",
    assignee: { name: "Marcus Chen", initials: "MC", color: "bg-emerald-600/30 text-emerald-200 border-emerald-500/40" },
    dueDate: "2026-07-20",
    priority: "High",
    status: "Blocked",
    progress: 30,
  ...
  {
    id: "TP-104",
    name: "Investigate AWS autoscaling node health probes",
    project: "Cloud Ops",
    assignee: { name: "AI Agent", initials: "AI", color: "bg-gradient-to-tr from-purple-500/40 to-cyan-500/40 text-cyan-200 border-purple-400/40" },
    dueDate: "2026-06-30",
    priority: "Medium",
    status: "Completed",
    progress: 100,
  ...
  {
    id: "TP-105",
    name: "Set up WebSocket notification microservice",
    project: "Notifications Microservice",
    assignee: { name: "Elena Rostova", initials: "ER", color: "bg-pink-600/30 text-pink-200 border-pink-500/40" },
    dueDate: "2026-07-28",
    priority: "Medium",
    status: "In Progress",
    progress: 48,
  ...
  {
    id: "TP-106",
    name: "Audit and document all REST API endpoints",
    project: "AI Workflow Planner",
    assignee: { name: "Sarah Jenkins", initials: "SJ", color: "bg-purple-600/30 text-purple-200 border-purple-500/40" },
    dueDate: "2026-07-18",
    priority: "Low",
    status: "Todo",
  ...
  {
    id: "TP-107",
    name: "Configure GitHub Actions CI/CD pipeline",
    project: "E2E Testing Pipeline",
    assignee: { name: "Marcus Chen", initials: "MC", color: "bg-emerald-600/30 text-emerald-200 border-emerald-500/40" },
    dueDate: "2026-07-25",
    priority: "High",
  ...
  {
    id: "TP-108",
    name: "Redesign landing page hero with glassmorphic grid",
    project: "Workspace Design Revamp",
    assignee: { name: "Elena Rostova", initials: "ER", color: "bg-pink-600/30 text-pink-200 border-pink-500/40" },
    dueDate: "2026-08-10",
    priority: "Low",
    status: "Todo",
  ...
  {
    id: "TP-109",
    name: "Resolve mock compilation error in E2E logs",
    project: "E2E Testing Pipeline",
    assignee: { name: "Marcus Chen", initials: "MC", color: "bg-emerald-600/30 text-emerald-200 border-emerald-500/40" },
    dueDate: "2026-07-05",
    priority: "High",
  ...
  {
    id: "TP-110",
    name: "Implement LLM sprint auto-planning prompts",
    project: "AI Workflow Planner",
    assignee: { name: "Alex Riviera", initials: "AR", color: "bg-cyan-600/30 text-cyan-200 border-cyan-500/40" },
    dueDate: "2026-07-12",
    priority: "High",
...
const PROJECTS = ["All Projects", "TaskPilot Auth System", "TaskPilot Core Layout", "E2E Testing Pipeline", "Cloud Ops", "Notifications Microservice", "AI Workflow Planner", "Workspace Design Revamp"];
        ...
        {open && (
          ...
          >
            {[
              ...
              { icon: Edit2,  label: "Edit",   danger: false },
          ...
          <div className="grid grid-cols-2 gap-4">
            ...
            <div className="space-y-1.5">
              <label className="text-zinc-400 font-bold flex items-center gap-1">
                <RiRobot2Line size={12} className="text-cyan-400" /> AI Risk Score
              </label>
              <input
                type="number" min={0} max={100}
...
export default function Tasks() {
  ...
  // id counter
  const nextId = useRef(tasks.length + 100 + 1);
  ...
  const filtered = tasks
    ...
    .sort((a, b) => {
      ...
      if (sortBy === "Due Date (DESC)") return new Date(b.dueDate) - new Date(a.dueDate);
      if (sortBy === "Priority") {
              ...
              <tbody className="divide-y divide-zinc-900/60">
                <AnimatePresence initial={false}>
                  {filtered.map((task, idx) => {
                    ...
                    const risk = getRiskStyle(task.riskScore);
                    const progressGradient = getProgressColor(task.status, task.progress);
                    ...
                    return (
                      ...
                      >
                        ...
                        <td className="py-3.5 px-4 text-zinc-400 whitespace-nowrap max-w-[160px]">
                          <span className="truncate block">{task.project}</span>
                        </td>
                        ...
                        <td className="py-3.5 px-4 whitespace-nowrap">
                          <div className="flex items-center gap-1.5">
                            <RiRobot2Line size={12} className={risk.text} />
                            <span className={`font-bold ${risk.text}`}>{task.riskScore}</span>
